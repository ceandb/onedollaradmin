                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Termine su pedido aqui!</h2>
                                <p>Ingresa los datos de envio.</p>
                                <!-- Form -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                ...
                                                <option selected value="GT">Guatemala</option>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Direccion principal 1<span>*</span></label>
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @if(session('coupon'))
                                            <li class="coupon_price" data-price="{{session('coupon')['value']}}">Ahorras<span>${{number_format(session('coupon')['value'],2)}}</span></li>
                                            @endif
                                            @php
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod"> <label> Pago contra entrega</label><br>
                                                <input name="payment_method" disabled  type="radio" value="paypal"> <label> Tarjeta credito / debito</label>
                                            </form-group>
