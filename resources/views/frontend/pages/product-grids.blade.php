...
@section('title','One Dolar | Productos')
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Agregar favoritos</span></a>
                                                    </div>
                                ...
                                @endforeach
                            @else
                                    <h4 class="text-warning" style="margin:100px auto;">No hay productos por el momento.</h4>
                            @endif
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                <div class="quickview-ratting-wrap">
                                                    ...
                                                    <a href="#"> ({{$rate_count}} Puntaje de clientes)</a>
                                                </div>
                                            ...
                                            <form action="{{route('single-add-to-cart')}}" method="POST">
                                                ...
                                                <div class="add-to-cart">
                                                    <button type="submit" class="btn" style="background-color: #0b9649">Agregar al carrito</button>
                                                    <a href="{{route('add-to-wishlist',$product->slug)}}" style="background-color: #0b9649" class="btn min"><i class="ti-heart"></i></a>
                                                </div>
                                            </form>
