...
@section('title','One Dolar | Carrito')
								...
								@else
										<tr>
											<td class="text-center">
												No hay productos en carrito. <a href="{{route('product-grids')}}" style="color:blue;">Continuar comprando</a>
							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Tienes un cupon?">
