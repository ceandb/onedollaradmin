...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-success float-left">Listado de Categorias</h6>
      <a href="{{route('category.create')}}" class="btn btn-success btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Agregar categoria</a>
    </div>
    <div class="card-body">
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    ...
                    text: "Si la eliminas asegurate de no tener productos relacionados a ella!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
