...
@section('title','One Dolar | Inicio')
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
          ...
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-success">Ganancias</h6>
...
<script type="text/javascript">
  ...
  function drawChart()
  {
      ...
      var options = {
          title : 'Usuarios registrados ultimos 7 dias'
      };
  ...
  <script type="text/javascript">
    ...
    Chart.defaults.global.defaultFontColor = '#0b9649';
                ...
                var myLineChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: "Earnings",
                      lineTension: 0.3,
                      backgroundColor: "rgb(11, 150, 73)",
                      borderColor: "rgb(11, 150, 73)",
                      pointRadius: 3,
                      pointBackgroundColor: "rgb(11, 150, 73)",
                      pointBorderColor: "rgb(11, 150, 73)",
                      pointHoverRadius: 3,
                      pointHoverBackgroundColor: "rgb(11, 150, 73)",
                      pointHoverBorderColor: "rgb(11, 150, 73)",
                      pointHitRadius: 10,
                      pointBorderWidth: 2,
