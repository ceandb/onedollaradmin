...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-left site-address">
      <h4 style="color:#0b9649 ">ONE DOLAR</h4>
      <p>CIUDAD DE GUATEMALA, GUATEMALA</p>
      <p>Phone: <a style="color: black" href="tel:+1234 567 567">+1234 567 567</a></p>
      <p>Email: <a style="color: black" href="mailto:info@onedollar.com">INFO@ONEDOLLAR.com</a></p>
    </div>
