...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <input id="inputTitle" type="text" name="code"  value="{{old('code')}}" class="form-control">
        @error('code')
        ...
        <div class="form-group">
            ...
            <input id="inputTitle" type="number" name="value"  value="{{old('value')}}" class="form-control">
            @error('value')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
