...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-success float-left">Lista de cupones</h6>
      <a href="{{route('coupon.create')}}" class="btn btn-success btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Agregar cupon</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        @if($coupon->status=='active')
                            <span class="badge badge-success">{{$coupon->status === "active" ? "ACTIVO" : "INACTIVO"}}</span>
                        @else
                            <span class="badge badge-warning">{{$coupon->status === "inactive" ? "INACTIVO" : "ACTIVO"}}</span>
                        @endif
                    </td>
                    <td>
        ...
        @else
          <h6 class="text-center">No tienes cupones, crea uno!</h6>
        @endif
      </div>
    </div>
</div>
