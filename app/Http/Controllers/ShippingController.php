...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Envio creado con exito');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','Envio no encontrado');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Envio actualizado con exito');
        }
        else{
            request()->session()->flash('error','Error, intente nuevamente');
        }
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            if($status){
                request()->session()->flash('success','Envio eliminado');
            }
            else{
                request()->session()->flash('error','Error, intente nuevamente');
            }
