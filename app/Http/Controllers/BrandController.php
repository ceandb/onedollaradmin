...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Marca creada con exito');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Marca actualizada con exito');
        }
        else{
            request()->session()->flash('error','Error, Intente nuevamente');
        }
    ...
    public function destroy($id)
    {
        ...
        if($brand){
            $status=$brand->delete();
            if($status){
                request()->session()->flash('success','Marca eliminada con exito');
            }
            else{
                request()->session()->flash('error','Error, Intente nuevamente');
            }
